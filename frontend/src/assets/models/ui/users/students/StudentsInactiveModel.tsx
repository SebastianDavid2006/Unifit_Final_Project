...
import { useGLTF, ContactShadows, Center, useProgress, Html, Clone } from '@react-three/drei'
...
function Model() {
  ...
  useFrame((_, delta) => {
    ...
    materialsRef.current.forEach((mat) => {
      mat.emissive = new THREE.Color('#F43843')
...
export function StudentsInactiveView() {
  return (
    <Canvas
