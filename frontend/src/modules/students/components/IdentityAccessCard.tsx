            ...
            >
              ...
              <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
                ...
                <div className="mt-6 text-center">
                  ...
                  {fpStatus === 'scanning' && (
                    <motion.div className="flex items-center gap-2 justify-center" animate={{ opacity: [1, 0.3, 1] }} transition={{ duration: 0.8, repeat: Infinity, ease: 'easeInOut' }}>
                      <motion.div animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: 'linear' }}><RefreshCw size={16} color={GREEN} /></motion.div>
                      <span className="text-xs font-medium" style={{ color: GREEN }}>
                        {fpStep ? STEP_MESSAGES[fpStep] : 'Escaneando huella...'}
                      </span>
                    </motion.div>
                  )}
