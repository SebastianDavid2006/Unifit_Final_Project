...
import {
  ...
  Activity, AlertTriangle, Upload, Plus
} from 'lucide-react'
          ...
          >
            ...
            >
              ...
              <div className="p-5 space-y-3">
                {/* Historial: lista de valoraciones (actual de primeras) */}
                {modal === 'history' && historySel === null && assessmentItems.map((a, i) => {
                  return (
                    <motion.button
                      key={a.num}
                      initial={{ opacity: 0, y: 14 }}
                ...
                {/* Datos personales por secciones */}
                {modal === 'personal' && personalSections.map(sec => (
                  <div key={sec.title}>
