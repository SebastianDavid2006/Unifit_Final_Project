...
export default function PersonalInfoSection({ form, onChange, erroresCampo = {} }: {
  form: NewUserForm
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <FormSelect label="Tipo de documento" value={form.tipoDoc} onChange={v => onChange('tipoDoc', v)} options={TIPO_DOC} required errors={erroresCampo.tipoDoc} />
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <FormSelect label="Género" value={form.genero} onChange={v => onChange('genero', v)} options={GENEROS} required errors={erroresCampo.genero} />
      </div>
