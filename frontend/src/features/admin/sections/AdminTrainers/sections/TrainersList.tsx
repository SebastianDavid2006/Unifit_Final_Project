...
export default function TrainersList({ paged, totalPages, currentPage, onPage, onSelectTrainer, onOpenNewUser }: {
  paged: Trainer[]
  totalPages: number
  currentPage: number
        ...
        <div className="space-y-2">
          {paged.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-xs mt-1" style={{ color: 'rgba(0,0,0,0.25)' }}>Prueba con otra búsqueda.</p>
            </div>
          ) : paged.map((t, i) => (
