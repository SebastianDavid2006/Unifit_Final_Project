...
export function AdminDashboard() {
  ...
  return (
    <div className="size-full overflow-y-auto" style={{ background: 'linear-gradient(180deg, #E8F0FF 0%, #F5F8FF 50%, #FFFFFF 100%)' }}>
      {/* Top bar */}
      <div className="sticky top-0 z-20 flex items-center justify-between px-8 py-4" style={{
        ...
        <div className="flex items-center gap-4">
          <div>
            <h2 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#1D1D1F', letterSpacing: '-0.02em', margin: 0 }}>Dashboard Administrativo</h2>
            <p style={{ fontSize: 12, margin: '2px 0 0 0', color: 'rgba(0,0,0,0.35)' }}>Universidad Nacional · Centro de Alto Rendimiento · Mayo 2026</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 px-3 py-2 rounded-xl" style={{
          ...
          <span className="text-xs font-medium" style={{ color: '#30D158' }}>Datos en tiempo real</span>
        </div>
      </div>

      <div className="relative z-10 p-8 space-y-6 max-w-[1440px] mx-auto">
        {/* KPIs - visible in all views */}
